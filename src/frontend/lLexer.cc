...
yy::location Lexer::getCurLocation()
{
  return curLocation;
}
...
int Lexer::getLastLine() const
{
  return lastNumOfLine;
}
...
void Lexer::updCurLoc()
{
  ...
  curLocation.begin.line = curLocation.end.line = cur_num_of_line;
